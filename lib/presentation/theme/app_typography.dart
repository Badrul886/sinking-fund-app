...
class AppTypography {
  ...
  static TextTheme getTextTheme(Color defaultColor) {
    return TextTheme(
      displayLarge: TextStyle(fontSize: 36, height: 42 / 36, color: defaultColor),
      displayMedium: TextStyle(fontSize: 30, height: 36 / 30, color: defaultColor),
      headlineLarge: TextStyle(fontSize: 26, height: 32 / 26, color: defaultColor),
      headlineMedium: TextStyle(fontSize: 22, height: 28 / 22, color: defaultColor),
      titleLarge: TextStyle(fontSize: 20, height: 26 / 20, color: defaultColor),
      titleMedium: TextStyle(fontSize: 17, height: 22 / 17, color: defaultColor),
      ...
      labelMedium: TextStyle(fontSize: 12, height: 16 / 12, color: defaultColor),
